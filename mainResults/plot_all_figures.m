...
% Start
    modelNameString = 'interval_normal_40m';
...
% Histograms
   ...
   % Save
       ...
       fileName = ['../figuresMain/competition_vs_monopoly_quantities', modelNameString];        
...
%    Save
        fileName = ['../figuresMain/competition_vs_surplus_quantities', modelNameString];        
...
fileName = ['../figuresMain/', modelNameString, '_', 'monopoly_and_equilibrium_prices'];        
...
fileName = ['../figuresMain/', modelNameString, '_', 'exclusion'];        
...
save(['../figuresMain/', modelNameString, '.mat'], 'table');